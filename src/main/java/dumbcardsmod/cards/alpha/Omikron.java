...
public class Omikron extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Omikron", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            15, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Omikron() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Pi();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Pi(), 1, true, false));
    }
