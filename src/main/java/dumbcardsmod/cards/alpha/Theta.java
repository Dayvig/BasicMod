...
public class Theta extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Theta", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Theta() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Iota();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Iota(), 1, true, false));
    }
