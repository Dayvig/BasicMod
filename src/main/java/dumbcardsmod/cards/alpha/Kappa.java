...
public class Kappa extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Kappa", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Kappa() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Lambda();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Lambda(), 1, true, false));
    }
