...
public class Zeta extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Zeta", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Zeta() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Eta();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Eta(), 1, true, false));
    }
