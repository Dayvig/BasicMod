...
public class Xl extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Xl", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            14, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Xl() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Omikron();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Omikron(), 1, true, false));
    }
