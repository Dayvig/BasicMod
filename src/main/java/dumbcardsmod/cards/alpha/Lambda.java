...
public class Lambda extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Lambda", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            11, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Lambda() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Mu();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Mu(), 1, true, false));
    }
