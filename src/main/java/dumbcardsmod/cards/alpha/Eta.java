...
public class Eta extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Eta", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            7, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Eta() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Theta();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Theta(), 1, true, false));
    }
