...
public class Pi extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Pi", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            16, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Pi() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Rho();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Rho(), 1, true, false));
    }
