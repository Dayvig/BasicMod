...
public class Iota extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Iota", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            9, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Iota() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Kappa();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Kappa(), 1, true, false));
    }
