...
public class Gamma extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Gamma", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Gamma() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Delta();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Delta(), 1, true, false));
    }
