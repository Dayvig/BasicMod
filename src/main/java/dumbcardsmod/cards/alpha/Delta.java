...
public class Delta extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Delta", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Delta() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Eplison();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Eplison(), 1, true, false));
    }
