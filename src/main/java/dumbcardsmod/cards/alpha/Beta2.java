...
public class Beta2 extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Beta2", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Beta2() {
        ...
        setExhaust(true);
        this.cardsToPreview = new Gamma();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new MakeTempCardInDrawPileAction(new Gamma(), 1, true, false));
    }
