...
public class Tau extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Tau", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
            19, //The card's base cost. -1 is X cost, -2 is no cost for unplayable cards like curses, or Reflex.
    ...
    public Tau() {
        ...
        setExhaust(true);
        //this.cardsToPreview = new Uplison();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //addToBot(new MakeTempCardInDrawPileAction(new Uplison(), 1, true, false));
    }
