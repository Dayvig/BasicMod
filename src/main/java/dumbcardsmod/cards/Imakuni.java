...
public class Imakuni extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "Imakuni", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public Imakuni() {
        ...
        setBackgroundTexture(characterPath("TrainerBack.png"),characterPath("TrainerBack2.png"));
