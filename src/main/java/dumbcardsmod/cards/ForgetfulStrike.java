...
public class ForgetfulStrike extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "ForgetfulStrike", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ExhaustRandomAction(1));
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new ForgetfulStrike();
    }
}
