...
import dumbcardsmod.powers.LifeSupportPower;
import dumbcardsmod.util.CardInfo;

import static dumbcardsmod.DumbCardsMod.makeID;

public class LifeSupport extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "LifeSupport", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new LifeSupportPower(p, magicNumber), magicNumber));
    }
