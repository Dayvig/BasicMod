...
public class PlotArmor extends BaseCard {

    private final static CardInfo cardInfo = new CardInfo(
            "PlotArmor", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public static final int UPGRADE_PLUS_BLOCK = 5;
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        ...
        if (AbstractDungeon.player.hasPower(CheaterPower.POWER_ID)){
            ...
            return false;
        } else if (AbstractDungeon.player.currentHealth > 5) {
